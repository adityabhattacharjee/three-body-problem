...
be done, but researchers who have actually found new examples needed far
more computing time than we used here, plus a clever way of first sorting
candidates by the general shape of the path they trace, before checking
