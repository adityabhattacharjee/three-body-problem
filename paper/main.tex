...
All code used in this paper -- the validated integrator, all four Q1
search scripts, both Q2 constructions, and the Manim sources for the
three videos -- along with the saved numerical results and the
\LaTeX{} sources for this paper, is available at
\url{https://github.com/adityabhattacharjee/three-body-problem}.
Every run uses a recorded random seed and integrator tolerance, listed in
that repository's \texttt{research/notes.md}, so every number in this
paper can be regenerated exactly.
